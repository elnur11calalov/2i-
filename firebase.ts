...
if (required.some((key) => !import.meta.env[key])) console.warn('Firebase environment variables are incomplete. See README.md.')
...
export const auth = getAuth(app); export const db = getFirestore(app); export const googleProvider = new GoogleAuthProvider(); googleProvider.setCustomParameters({ prompt: 'select_account' })
